...
export interface EntryFormProps {
  ...
  onSaved?: (entry: MotivationEntry) => void;
  onCancel?: () => void;
}

/** Add/edit form for a Motivation entry. The Private toggle is offered only to Keira (student
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <Field label="Link to an experience entry" hint="Optional — connect this to an experience-hours entry.">
