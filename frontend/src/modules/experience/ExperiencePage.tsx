...
/** Experience Hours — structured log, summary dashboard, supervisor directory, PDF export. */
export default function ExperiencePage() {
  ...
  async function handleDelete(entry: ExperienceEntry): Promise<void> {
    if (!window.confirm(`Delete the ${entry.date} entry at ${entry.facility}?`)) return;
    try {
      await deleteExperience(entry.entryId);
