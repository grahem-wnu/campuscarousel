// Pure aggregation for GET /clinical/summary. Kept separate from the handler so it is trivially
...
export function summarize(entries: readonly Clinical[]): ClinicalSummary {
