...
/**
 * Why-Nursing categories. Mirrors the data-layer `WhyNursing['category']` union (the frozen
...
/** Body for POST /why-nursing. `.strict()` rejects unknown fields so typos surface as 422. */
...
/** Body for PUT /why-nursing/:id — every field optional. */
export const updateSchema = createSchema.partial();

/** Query for GET /why-nursing — unknown params are ignored (API Gateway may add some). */
