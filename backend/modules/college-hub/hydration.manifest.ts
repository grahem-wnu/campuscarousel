...
// One registration handles both async college jobs on the shared queue, routed by message shape:
// a `jobId` is a discovery job; otherwise it's a hydration job (`collegeId`).
