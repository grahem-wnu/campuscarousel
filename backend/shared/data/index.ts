...
import {
  ...
  makeCollegeNotes,
  makeCollegeScholarshipSearch,
  makeCollegeScholarships,
  makeCareerPath,
  makeConversations,
  makeFocusOverview,
  makeInvites,
...
export function makeData(
  ...
  return {
    ...
    collegeScholarships: makeCollegeScholarships(client),
    collegeScholarshipSearch: makeCollegeScholarshipSearch(client),
